...
2. Confirm the project uses Zig `0.17.0-dev.1415+64dfaa568` or a compatible newer 0.17 development build.
3. Add the package with `zig fetch --save=vulkan "git+https://github.com/zmscode/vk-zig.git#zig-0.17-dev"`.
...
- Keep specialty compute in its focused namespace: `vk.optical_flow`, `vk.tensor`,
